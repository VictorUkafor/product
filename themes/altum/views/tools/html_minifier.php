        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <textarea id="html" name="html" class="form-control <?= \Altum\Alerts::has_field_errors('html') ? 'is-invalid' : null ?>" required="required"><?= htmlentities($data->values['html']) ?></textarea>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="result" class="form-control"><?= htmlentities($data->result) ?></textarea>
                    </div>
