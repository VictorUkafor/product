            ...
            <table class="table table-custom">
                ...
                <?php foreach($data->blog_posts_categories as $row): ?>
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <div class="d-flex align-items-center">
                                <span class="mr-2" data-toggle="tooltip" title="<?= sprintf(l('admin_blog.table.datetime'), \Altum\Date::get($row->datetime)) ?>">
                                    <i class="fa fa-fw fa-calendar text-muted"></i>
                                </span>

                                <span class="mr-2" data-toggle="tooltip" title="<?= sprintf(l('admin_blog.table.last_datetime'), ($row->last_datetime ? \Altum\Date::get($row->last_datetime) : '-')) ?>">
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                <?= include_view(THEME_PATH . 'views/admin/blog-posts-categories/admin_blog_posts_category_dropdown_button.php', ['id' => $row->blog_posts_category_id]) ?>
                            </div>
                        </td>
                    </tr>
                <?php endforeach ?>
...
<?php \Altum\Event::add_content(include_view(THEME_PATH . 'views/admin/blog-posts-categories/blog_posts_category_delete_modal.php'), 'modals'); ?>
