...
<div class="d-flex justify-content-between mb-4">
    ...
    <?= include_view(THEME_PATH . 'views/admin/blog-posts-categories/admin_blog_posts_category_dropdown_button.php', ['id' => $data->blog_posts_category->blog_posts_category_id]) ?>
</div>
