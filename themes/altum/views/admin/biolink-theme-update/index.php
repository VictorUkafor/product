...
<div class="d-flex justify-content-between mb-4">
    ...
    <?= include_view(THEME_PATH . 'views/admin/biolinks-themes/admin_biolink_theme_dropdown_button.php', ['id' => $data->biolink_theme->biolink_theme_id]) ?>
</div>
    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <?php endif ?>
                <input id="image" type="file" name="image" accept="<?= \Altum\Uploads::get_whitelisted_file_extensions_accept('biolinks_themes') ?>" class="form-control-file" />
            ...
            <div id="biolink_background_type_image">
                <div class="form-group">
                    ...
                    <?php if(!empty($data->biolink_theme->settings->biolink->background) && is_string($data->biolink_theme->settings->biolink->background) && file_exists(UPLOADS_PATH . 'backgrounds/' . $data->biolink_theme->settings->biolink->background)): ?>
                    ...
                    <?php endif ?>
                    <input id="biolink_background_image" type="file" name="biolink_background_image" accept=".gif, .png, .jpg, .jpeg, .svg, .mp4" class="form-control-file" />
...
<?php \Altum\Event::add_content(include_view(THEME_PATH . 'views/admin/biolinks-themes/biolink_theme_delete_modal.php'), 'modals'); ?>
