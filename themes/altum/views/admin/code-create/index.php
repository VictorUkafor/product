...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        ...
        <form action="" method="post" role="form" x-data="{ type: $refs.type.value, is_bulk: $refs.is_bulk.checked }">
            <input type="hidden" name="token" value="<?= \Altum\Middlewares\Csrf::get() ?>" />

            <div class="form-group">
                <label for="name"><?= l('admin_codes.main.name') ?></label>
                <input type="text" id="name" name="name" class="form-control form-control-lg" required="required" :disabled="is_bulk" />
            </div>

            <div class="form-group">
                <label for="type"><?= l('admin_codes.main.type') ?></label>
                <select id="type" name="type" class="form-control form-control-lg" x-ref="type" x-on:change="type = $el.value">
            ...
            <div class="form-group">
                ...
                <input type="text" id="code" name="code" class="form-control form-control-lg" required="required" :disabled="is_bulk" />
            </div>

            <div id="discount_container" class="form-group" :class="type == 'discount' ? '' : 'd-none'">
            ...
            <div id="days_container" class="form-group" :class="type == 'redeemable' ? '' : 'd-none'">
            ...
            <div class="custom-control custom-switch mb-3">
                <input id="is_bulk" name="is_bulk" type="checkbox" class="custom-control-input" x-ref="is_bulk" @change="is_bulk = $el.checked">
                <label class="custom-control-label" for="is_bulk"><?= l('admin_codes.main.is_bulk') ?></label>
            </div>

            <div id="bulk_container" :class="is_bulk ? '' : 'd-none'">
                <div class="form-group">
...
<?php ob_start() ?>
<script src="<?= ASSETS_FULL_URL . 'js/libraries/alpinejs.min.js' ?>"></script>
