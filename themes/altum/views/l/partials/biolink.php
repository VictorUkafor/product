...
<video autoplay muted loop playsinline class="link-video-background <?= string_ends_with('.mp4', $data->link->settings->background) ? '' : 'd-none' ?>">
    <source src="<?= UPLOADS_FULL_URL . 'backgrounds/' . $data->link->settings->background ?>" type="video/mp4">
</video>
